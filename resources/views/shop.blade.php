                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <a href="{{route('shop.product.details',["product_slug"=>$product->slug])}}">
                                <img loading="lazy" src="{{asset('storage/products/')}}/{{$product->image}}" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img">                                            
                            </a>
                        </div>
                        <div class="swiper-slide">
                            @foreach (explode(",",$product->images) as $gimg)
                                <a href="{{route('shop.product.details',["product_slug"=>$product->slug])}}">
                                    <img loading="lazy" src="{{asset('storage/products/')}}/{{trim($gimg)}}" width="330" height="400" alt="Cropped Faux leather Jacket" class="pc__img">
                                </a>
                            @endforeach                                        
                        </div>
                    </div>
